...
public class SandArtDriver // Driver Program
{
   ...
   public static void main(String[] args) {
      ...
      JFrame frame = new JFrame("DUE TO INCLEMENT WEATHER, ALL FAIRFAX COUNTY PUBLIC SCHOOLS WILL BE CLOSED TODAY"); // window
                                                                                                                     // title
      ...
      // make the regular mouse cursor transparent so we can use a custom one in the
      // MMMPanel that changes depending on direction
